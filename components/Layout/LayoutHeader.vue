...
<template>
    <header v-show="!loading" class="sticky border-b-2 border-neutral-ash bg-white top-0">
        <div class="container py-3 md:pb-0 md:pt-6">
            <div class="flex items-center justify-between gap-2">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <LazyLayoutSidebar v-if="offcanvasCartController.isOpen" :controller="offcanvasCartController" side="right">
                    offcanvas cart
                  </LazyLayoutSidebar>
                </div>
            </div>
          ...
          <div class="flex gap-2 relative">
              ...
              >
                <NuxtLink
                    ...
                    class="text-neutral-black pb-3 mr-5 lg:mr-8 lg:py-4 inline-block border-b border-white hover:border-neutral-black transition-all"
                    :class="{
