...
<template>
    ...
    >
        ...
        >
            <svg
                aria-hidden="true"
                class="dark:text-gray-600 h-8 w-8 animate-spin fill-status-important text-gray"
                viewBox="0 0 100 101"
                fill="none"
    ...
    <template v-else>
        ...
        >
            <svg
                aria-hidden="true"
                class="dark:text-gray-600 animate-spin fill-status-important text-gray-light"
                :class="{
                    'h-8 w-8': size === 'normal',
                    'h-5 w-5': size === 'small',
                }"
