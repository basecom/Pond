...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:button__input": {
    ...
    "rounded":true,
    "border": true,
    "border-color-brand-primary": true,
    "text-brand-primary": true,
    "text-bold": true,
    "hover:border-color-brand-secondary": true,
    "hover:text-brand-secondary": true,
    "disabled:!cursor-not-allowed": true,
    "disabled:bg-gray-light": true,
    "disabled:border-color-gray": true,
  ...
  "family:box__decorator": {
    ...
    "peer-disabled:bg-border-gray": true,
    "peer-disabled:text-gray": true,
  ...
  "family:text__inner": {
    ...
    "items-inner": true,
    "group-data-[invalid]:border-brand-secondary": true,
